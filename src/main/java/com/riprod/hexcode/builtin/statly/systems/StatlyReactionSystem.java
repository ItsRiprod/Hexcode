package com.riprod.hexcode.builtin.statly.systems;
...
public class StatlyReactionSystem extends DamageEventSystem {
    ...
    public void handle(int index, @Nonnull ArchetypeChunk<EntityStore> chunk,
        ...
        try {
            ...
            for (int effectIndex : activeIndexes) {
                ...
                interaction.apply(new StatlyReactionContext(
                        buffer, ref, damage, attackerCauseId, element.getId(), hitPos));
            }
        } catch (Exception e) {
            LOGGER.atSevere().log("StatlyReactionSystem failed: %s", e.getMessage());
        }
    }
}

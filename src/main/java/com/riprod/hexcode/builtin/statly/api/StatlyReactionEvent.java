package com.riprod.hexcode.builtin.statly.api;
...
public class StatlyReactionEvent extends CancellableEcsEvent {
    ...
    public StatlyReactionEvent(Ref<EntityStore> targetRef, String elementId, String causeId,

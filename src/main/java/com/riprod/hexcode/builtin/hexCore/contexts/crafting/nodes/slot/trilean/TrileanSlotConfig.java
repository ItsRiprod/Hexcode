...
public final class TrileanSlotConfig extends SlotConfig {
    public static final String TYPE = "Boolean";

    public static final BuilderCodec<TrileanSlotConfig> CODEC = BuilderCodec
            .builder(TrileanSlotConfig.class, TrileanSlotConfig::new, SlotConfig.BASE_CODEC)
    ...
    @Nullable
    public String labelFor(TrileanSlotState state) {
        return switch (state) {
    ...
    @Nullable
    public String descriptionFor(TrileanSlotState state) {
        return switch (state) {
    ...
    @Override
    public Slot create() {
        return new TrileanSlot();
    }

    @Override
    public NodeInterface handler() {
        return TrileanSlotHandler.INSTANCE;
    }

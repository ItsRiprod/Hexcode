package com.riprod.hexcode.builtin.hexCore.glyphs.utilities.modulo;
...
public class ModuloGlyph implements GlyphHandler {
    @Override
    public String getId() {
        return ID;
    }

    public static final String ID = "Modulo";

    private HexVar compute(Glyph glyph, HexContext hexContext) {
        HexVar a = glyph.readSlot(ModuloGlyphSlots.A, hexContext);
        HexVar b = glyph.readSlot(ModuloGlyphSlots.B, hexContext);
        if (a == null && b == null)
            return null;
        if (a == null)
            return b;

...
public final class MageArmorConfig extends ElementGlyphConfig {

    public static final MageArmorConfig DEFAULTS = new MageArmorConfig();

    private String statusEffect = "Life";
    ...
    public static final BuilderCodec<MageArmorConfig> CODEC = BuilderCodec
            .builder(MageArmorConfig.class, MageArmorConfig::new, ElementGlyphConfig.BASE_CODEC)

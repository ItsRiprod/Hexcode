package com.riprod.hexcode.builtin.hexCore.contexts.crafting.nodes.anchor;
...
/**
 * Anchor Node is the entry point of the hex when in Crafting Mode
 * 
 * It works as the first node you can drag from
 * AnchorNodeHandler
 */

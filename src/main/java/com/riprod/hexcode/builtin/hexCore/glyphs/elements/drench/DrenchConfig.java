...
public final class DrenchConfig extends ElementGlyphConfig {

    public static final DrenchConfig DEFAULTS = new DrenchConfig();
    ...
    public static final BuilderCodec<DrenchConfig> CODEC = BuilderCodec
            .builder(DrenchConfig.class, DrenchConfig::new, ElementGlyphConfig.BASE_CODEC)

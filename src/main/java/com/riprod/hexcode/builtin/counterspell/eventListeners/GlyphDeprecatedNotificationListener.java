...
public class GlyphDeprecatedNotificationListener implements Consumer<GlyphDrawnEvent> {
    ...
    public void accept(GlyphDrawnEvent event) {
        ...
        Message name = Message.translation("server.hexcode.notifications.glyphDeprecated").param("glyphName",

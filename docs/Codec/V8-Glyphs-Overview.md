...
### \[𝟢\] Drain
> Drain is in the middle of being rebalanced. May not behave as intended until then
...
### \[◯□\] Area
> Area may behave strangely when scaled up too large or doing complex downstream glyphs
...
### \[◇▽𝟢\] Levitate\*
> Levitate was revised in v0.9 - currently is very extreme
...
### \[◯◯◯\] Bolt
> Damage and Cost scales incorrectly with Magnitude.
...
> Boolean values are not implemented in v0.8
...
## Conditions
> Conditions may not work properly in v0.8
